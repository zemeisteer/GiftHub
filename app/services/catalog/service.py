...
DEFAULT_PRODUCTS = [
    # Stars
    {
        ...
        "quantity": 50,
        "base_price_uzs": Decimal("11000.00"),
        "display_order": 1,
        "badge_text": "",
    },
    {
        ...
        "quantity": 100,
        "base_price_uzs": Decimal("21500.00"),
        "display_order": 2,
        "badge_text": "Ommabop",
    },
    {
        ...
        "quantity": 250,
        "base_price_uzs": Decimal("53000.00"),
        "display_order": 3,
        "badge_text": "",
    },
    {
        ...
        "quantity": 500,
        "base_price_uzs": Decimal("105000.00"),
        "display_order": 4,
        "badge_text": "Qulay",
    },
    {
        ...
        "quantity": 1000,
        "base_price_uzs": Decimal("209000.00"),
        "display_order": 5,
        "badge_text": "-5%",
    },
    # Premium
    {
        ...
        "quantity": 1,
        "duration_months": 3,
        "base_price_uzs": Decimal("145000.00"),
        "display_order": 1,
        "badge_text": "",
    },
    {
        ...
        "quantity": 1,
        "duration_months": 6,
        "base_price_uzs": Decimal("195000.00"),
        "display_order": 2,
        "badge_text": "Eng mashhur",
    },
    {
        "category": "premium",
        "sku": "premium_12m",
        "title": "Telegram Premium 12 oylik",
        "quantity": 1,
        "duration_months": 12,
        "base_price_uzs": Decimal("320000.00"),
        "display_order": 3,
        "badge_text": "-25%",
    },
    # Gifts
    {
        "category": "gift",
        "sku": "gift_teddy",
        "title": "Teddy Bear Sovg'asi",
        "quantity": 15,
        "base_price_uzs": Decimal("35000.00"),
        "display_order": 1,
        "badge_text": "Yangi",
    },
    {
        "category": "gift",
        "sku": "gift_heart",
        "title": "Red Heart Sovg'asi",
        "quantity": 25,
        "base_price_uzs": Decimal("55000.00"),
        "display_order": 2,
        "badge_text": "Romantik",
    },
    {
        "category": "gift",
        "sku": "gift_cake",
        "title": "Birthday Cake Sovg'asi",
        "quantity": 50,
        "base_price_uzs": Decimal("110000.00"),
        "display_order": 3,
        "badge_text": "Tavsiya",
    },
]
...
class CatalogService:
    ...
    async def list_products(
        session: AsyncSession, category: Optional[str] = None, active_only: bool = True
    ) -> List[CatalogProduct]:
    ...
    @staticmethod
    async def update_product(session: AsyncSession, product_id: int, **kwargs) -> Optional[CatalogProduct]:
